...
<script>
  ...
  <body>
<input type = "hidden" value = <?echo $first?> id = "firstname"  >
<input type = "hidden" value = <?echo $last?> id = "lastname" > 
 <div class="col-md-3">
  </div>
  <div class="col-md-7">
...
<div class="col-md-2">
	...
	<div style = "text-align: center;margin-top : 5px" >
	  <button type="button" class="btn btn-primary" style = "width:150px;" id = "client">Consultant Search</button>
	  </div>
    </div>	
...
<tbody id = "exist_table_body">
	  ...
	  <form action="https://iub.edu/~isccint/test/Consultant_add.html">
    <input type="submit" class="btn btn-primary" value = "Add Consultant">
</form>
...
<script src = "../js/consultant_search.js">
</script>
</html>
